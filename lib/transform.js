...
const createPendingFilesPassthrough = () => createTransform(function (file, _enc, cb) {
  // Don't process deleted file who haven't been commited yet.
  cb(undefined, isFilePending(file) ? file : undefined);
});

const createCommitTransform = memFsEditor => createTransform(function (file, _enc, cb) {
